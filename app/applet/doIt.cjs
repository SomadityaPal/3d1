...
code = code.replace(/<h2 className="text-3xl md:text-5xl font-serif font-light tracking-tight text-neutral-100 leading-tight">/g, '<h2 className="text-3xl md:text-5xl font-serif font-light tracking-tight text-neutral-100 leading-tight min-h-[4em] md:min-h-[2em] flex items-center justify-center">');
...
code = code.replace(/<h2 className="text-3xl md:text-5xl font-serif font-light tracking-tight">/g, '<h2 className="text-3xl md:text-5xl font-serif font-light tracking-tight min-h-[4em] md:min-h-[2em] flex items-center justify-center">');
code = code.replace(/<h2 className="text-3xl md:text-5xl font-serif font-light text-neutral-100 tracking-tight">/g, '<h2 className="text-3xl md:text-5xl font-serif font-light text-neutral-100 tracking-tight min-h-[4em] md:min-h-[2em] flex items-center justify-center">');
code = code.replace(/<h2 className="text-lg md:text-2xl font-serif text-neutral-300 italic">/g, '<h2 className="text-lg md:text-2xl font-serif text-neutral-300 italic min-h-[4em] md:min-h-[2em] flex items-center justify-center">');
code = code.replace(/<h2 className="text-2xl md:text-4xl font-serif italic text-gold-100 leading-relaxed font-light">/g, '<h2 className="text-2xl md:text-4xl font-serif italic text-gold-100 leading-relaxed font-light min-h-[4.5em] md:min-h-[2em] flex items-center">');
